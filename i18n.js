...
(function () {
  ...
  const EXACT = {
    ...
    "Ամեն ընկերոջ համար՝ նոր կոդ։ Օգտագործվելուց հետո այն այլևս չի աշխատում։": { en: "A fresh code for each friend. Once it is used, it stops working.", ru: "Новый код для каждого друга. После использования он перестаёт работать." },
